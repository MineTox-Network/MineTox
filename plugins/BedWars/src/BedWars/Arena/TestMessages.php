...
class TestMessages extends MiniGameBase {
	...
	public function runTests() {
		...
		$this->testMessage("team.join-yellow");
		$this->testMessage("team.join-green");
		...
		$this->testMessage("team.scores.yellow-players");	
		$this->testMessage("team.scores.green-players");	
		$this->testMessage("team.scores.redteam-wins");
		$this->testMessage("team.scores.blueteam-wins");
		$this->testMessage("team.scores.yellowteam-wins");
		$this->testMessage("team.scores.greenteam-wins");
		...
		$this->testMessage("ctf.blue-team.capturedflag");
                $this->testMessage("ctf.yellow-team.capturedflag");
                $this->testMessage("ctf.green-team.capturedflag");
		$this->testMessage("ctf.blue-team.score" );
		$this->testMessage("ctf.red-team.score" );		
		...
		$this->testMessage("team.yellow");
		$this->testMessage("team.green");
		$this->testMessage("team.joined-blue");
		$this->testMessage("team.joined-yellow");
		$this->testMessage("team.joined-green");
		...
		$this->testMessage("ctf.error.wrong-sender");			
                $this->testMessage("team.blue-no-players");
		$this->testMessage("team.red-no-players");
		$this->testMessage("team.yellow-no-players");
		$this->testMessage("team.-no-players");
		...
		$this->testMessage("team.left-yellow");
		$this->testMessage("team.left-green");
		$this->testMessage("ctf.return-flag");
		$this->testMessage("game.final.draw");
		$this->testMessage("game.final.red-win");		
		$this->testMessage("game.final.blue-win");		
		$this->testMessage("game.final.yellow-win");
		$this->testMessage("game.final.green-win");
